...
function handleClick(id) {
    ...
    function pass(num, num2, a, b, c, d) {
        ...
        if (playerTurn === 0) {
            ...
            document.getElementById("player" + num + "TotalScore").textContent = "Total Score: " + totalScore0;
        } else if (playerTurn === 1) {
