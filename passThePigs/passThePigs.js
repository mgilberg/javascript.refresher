...
function pass(num, num2, a, b, c, d) {
    ...
    if (playerTurn === 0) {
        ...
        document.getElementById("player" + 1 + "TotalScore").textContent = "Total Score: " + totalScore2;
    } else if (playerTurn === 2) {
